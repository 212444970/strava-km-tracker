...
def main():
    with sync_playwright() as p:
        ...
        print("Otevírám Garmin Connect...")
        page.goto("https://connect.garmin.com/modern/activities")

        print("\nPřihlas se ve webovém okně.")
        print("Jakmile vidíš seznam aktivit (ne přihlašovací stránku), stiskni Enter...")
        input()
        ...
        browser.close()
        print(f"Staženo {len(all_raw)} záznamů ze serveru.")
        ...
        print(f"\nHotovo! Uloženo {len(activities)} aktivit do {OUTPUT}")
        print("\nDalší krok:")
